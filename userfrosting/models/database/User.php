...
class User extends UFModel {
    ...
    public function getServiceIds(){
        ...
        // Fetch from database, if not set
        $branches = Branch::where('company_id', $this->company_id)->get();
        ...
        // if (!isset($this->_services)){    
            ...
            $result = Capsule::table($link_table)->select("service_id")->whereIn("branch_id", $branches_id)->groupBy("service_id")->get();
// print_r($result);
// exit();
            $this->_services = [];
